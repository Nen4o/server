(function (global, factory) {
    ...
    var seedData = {
        ...
        projects: {
            "0": {
                "name": "ReflecsabelExabel",
                "imageUrl": "https://play-lh.googleusercontent.com/P6CMfSpLoh3xiCaIlNJvpBqwUTUNdQjo3wbtKciyJo2sonERWXmyfLfp4z34QkY8uL8=w240-h480-rw",
                "detailsImageUrl": "https://play-lh.googleusercontent.com/K9MkWdh-Na_mHGSPf_PCA71p6RlN6AvRVXyn6PBMs-X3QfXfdJSSZ9GSxqumMaXfPx4=w416-h235-rw",
                "description": "This was my first 'sucsessful' project :)",
                "moreInfo": `I start to study programing because i wanted to create videogames.
                At first i start with tutorials from youtube that i don\`t understend,
                but then hear about 'Unity3D' corse from SoftUni.
                I startrd the course and get it. 
                Now i have the skills to make game, 
                so i decided to make someting like chalinge and to create game for like 3-hours.
                I started, and create base functionality for the game, and in next 1 mounth i add some color, shop, tutorial
                and much more. Then i was happy... was i? I feel like i needed to make someting bigger with this game,
                so yes, i post it in GooglePlay :). The game is not big deal, it have tons of bugs but who care, the game is not popular,
                and i don\`t want it to be. I started this project to crate game and then to post game in GooglePlay, and i did it.`
            }
        }
    };
    var rules$1 = {
